 ...
 */
@DatabaseTable(tableName = "townClaims")
@Getter
@Setter
public class TownClaim extends BaseDaoEnabled<TownClaim, UUID> implements ClaimBlock {
    ...
    public TownClaim get() {
        return this;
    }

    public static TownClaim of(Town parent, Vector3i location, UUID world) {
        TownClaim claim = new TownClaim();
        claim.setDao(SpongyTowns.getStorage().getTownClaims());
        claim.setParent(parent);
        claim.setTownId(claim.getParent().getUniqueId());
